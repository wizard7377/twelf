...
struct
    ...
    fun  (* GEN BEGIN CASE FIRST *) (* GEN BEGIN CASE FIRST *) split (h::tl) 0 = ([], h, tl) (* GEN END CASE FIRST *) (* GEN END CASE FIRST *)
       | (* GEN BEGIN CASE BRANCH *) split (h::tl) n = let 
       	     (* GEN BEGIN TAG OUTSIDE LET *) val (pre, thing, post) = split tl (n-1) (* GEN END TAG OUTSIDE LET *)
       	 in
       	     (h::pre, thing, post)
       	 end (* GEN END CASE BRANCH *)
       | (* GEN BEGIN CASE BRANCH *) (* GEN BEGIN CASE BRANCH *) split [] n = split [NONE] n (* GEN END CASE BRANCH *) (* GEN END CASE BRANCH *) 

    fun clear () = let in
    		       Array.modify ((* GEN BEGIN FUNCTION EXPRESSION *) (* GEN BEGIN FUNCTION EXPRESSION *) fn _ => NONE (* GEN END FUNCTION EXPRESSION *) (* GEN END FUNCTION EXPRESSION *)) sigma;
    		       Array.modify ((* GEN BEGIN FUNCTION EXPRESSION *) (* GEN BEGIN FUNCTION EXPRESSION *) fn _ => NONE (* GEN END FUNCTION EXPRESSION *) (* GEN END FUNCTION EXPRESSION *)) all_modes;
    		       Array.modify ((* GEN BEGIN FUNCTION EXPRESSION *) (* GEN BEGIN FUNCTION EXPRESSION *) fn _ => NONE (* GEN END FUNCTION EXPRESSION *) (* GEN END FUNCTION EXPRESSION *)) all_ps
    		   end
