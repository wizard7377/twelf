...
functor (* GEN BEGIN FUNCTOR DECL *) (* GEN BEGIN FUNCTOR DECL *) SparseArray (structure IntTable : TABLE where type key = int)
  :> SPARSE_ARRAY =
struct
...
end (* GEN END FUNCTOR DECL *) (* GEN END FUNCTOR DECL *);  (* structure SparseArray *)
