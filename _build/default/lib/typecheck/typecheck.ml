...
functor (* GEN BEGIN FUNCTOR DECL *) (* GEN BEGIN FUNCTOR DECL *) TypeCheck ((*! structure IntSyn' : INTSYN !*)
                   structure Conv : CONV
...
end (* GEN END FUNCTOR DECL *) (* GEN END FUNCTOR DECL *); (* functor TypeCheck *)
