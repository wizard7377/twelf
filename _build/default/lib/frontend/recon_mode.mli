...
(* GEN BEGIN SIGNATURE DECLARATION *) signature EXTMODES =
sig
...
end (* GEN END SIGNATURE DECLARATION *);  (* signature EXTMODES *)


(* GEN BEGIN SIGNATURE DECLARATION *) signature RECON_MODE =
sig
  (*! structure ModeSyn : MODESYN !*)
  include EXTMODES

  exception Error of string
  val modeToMode : modedec -> (IntSyn.cid * ModeSyn.mode_spine) * Paths.region
end (* GEN END SIGNATURE DECLARATION *);  (* signature RECON_MODE *)
