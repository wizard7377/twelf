...
(* GEN BEGIN SIGNATURE DECLARATION *) signature EXTSYN =
sig
...
end (* GEN END SIGNATURE DECLARATION *);  (* signature EXTSYN *)

(* signature RECON_TERM
   provides the interface to type reconstruction seen by Twelf 
*)

(* GEN BEGIN SIGNATURE DECLARATION *) signature RECON_TERM =
sig
...
end (* GEN END SIGNATURE DECLARATION *);  (* signature RECON_TERM *)
