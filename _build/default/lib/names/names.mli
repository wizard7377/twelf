...
(* GEN BEGIN SIGNATURE DECLARATION *) signature FIXITY =
sig
...
end (* GEN END SIGNATURE DECLARATION *);  (* signature FIXITY *)

(* GEN BEGIN SIGNATURE DECLARATION *) signature NAMES =
sig
  ...
  val conDecQid : IntSyn.con_dec -> qid
  ...
  val nameConDec : IntSyn.con_dec -> IntSyn.con_dec
