...
(* GEN BEGIN SIGNATURE DECLARATION *) signature TRAVERSER =
sig
...
end (* GEN END SIGNATURE DECLARATION *);  (* signature TRAVERSER *)

(* GEN BEGIN SIGNATURE DECLARATION *) signature TRAVERSE =
sig
  ...
  val fromConDec : IntSyn.con_dec -> Traverser.condec option

  val const : string -> Traverser.condec

end (* GEN END SIGNATURE DECLARATION *);  (* signature TRAVERSE *)
