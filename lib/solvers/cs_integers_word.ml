...
let rec installFgnCnstrOps ()  = ( let csid = ! myID in let _ = FgnCnstrStd.ToInternal.install (csid, (function MyFgnCnstrRepPlus (G, _, U1, U2, U3) -> toInternalPlus (G, U1, U2, U3) | MyFgnCnstrRepTimes (G, _, U1, U2, U3) -> toInternalTimes (G, U1, U2, U3) | MyFgnCnstrRepQuot (G, _, U1, U2, U3) -> toInternalQuot (G, U1, U2, U3) | fc -> raise ((UnexpectedFgnCnstr fc)))) in let _ = FgnCnstrStd.Awake.install (csid, (function MyFgnCnstrRepPlus (G, proof, U1, U2, U3) -> awakePlus (G, proof, U1, U2, U3) | MyFgnCnstrRepTimes (G, proof, U1, U2, U3) -> awakeTimes (G, proof, U1, U2, U3) | MyFgnCnstrRepQuot (G, proof, U1, U2, U3) -> awakeQuot (G, proof, U1, U2, U3) | fc -> raise ((UnexpectedFgnCnstr fc)))) in let _ = FgnCnstrStd.Simplify.install (csid, (function MyFgnCnstrRepPlus _ -> (fun () -> false) | MyFgnCnstrRepTimes _ -> (fun () -> false) | MyFgnCnstrRepQuot _ -> (fun () -> false) | fc -> raise ((UnexpectedFgnCnstr fc)))) in  () )
