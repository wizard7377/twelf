...
(*! structure IntSyn : INTSYN !*)
  ...
  val queryToQuery : query * Paths.location -> IntSyn.exp * string option * IntSyn.exp * string list
(* (A, SOME("X"), [(Y1, "Y1"),...] *)
(* where A is query type, X the optional proof term variable name *)
(* Yi the EVars in the query and "Yi" their names *)
  val solveToSolve : define list * solve * Paths.location -> IntSyn.exp * (IntSyn.exp -> IntSyn.conDec * Paths.occConDec option list)
