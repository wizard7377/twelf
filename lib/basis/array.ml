...
module Array : ARRAY = struct
  ...
  let copy : src:'a array -> dst:'a array -> di:int -> unit =
    assert false (* TODO *)

  let copyVec : src:'a vector -> dst:'a array -> di:int -> unit =
    assert false (* TODO *)
  ...
  let foldli : (int * 'a * 'b -> 'b) -> 'b -> 'a array -> 'b =
    assert false (* TODO *)

  let foldri : (int * 'a * 'b -> 'b) -> 'b -> 'a array -> 'b =
    assert false (* TODO *)

  let foldl : ('a * 'b -> 'b) -> 'b -> 'a array -> 'b = assert false (* TODO *)
  let foldr : ('a * 'b -> 'b) -> 'b -> 'a array -> 'b = assert false (* TODO *)

  let findi : (int * 'a -> bool) -> 'a array -> (int * 'a) option =
    assert false (* TODO *)
  ...
  let collate : ('a * 'a -> order) -> 'a array * 'a array -> order =
    assert false (* TODO *)
end
