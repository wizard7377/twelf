...
(*     | F1 ^ F2              *)
  type pro = Lam of lFDec * pro | Inx of IntSyn.exp * pro | Unit | Rec of mDec * pro | Let of decs * pro | Case of opts | Pair of pro * pro and opts = Opts of lfctx * IntSyn.sub * pro list and mDec = MDec of string option * for_sml and decs = Empty | Split of int * decs | New of ctxBlock * decs | App of (int * IntSyn.exp) * decs | PApp of (int * int) * decs | Lemma of lemma * decs | Left of int * decs | Right of int * decs
(*      | xx = pi2 yy, Ds     *)
