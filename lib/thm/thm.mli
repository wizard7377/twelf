...
(*! structure Paths : PATHS !*)
  ...
  val installTotal : ThmSyn.tDecl * (Paths.region * Paths.region list) -> IntSyn.cid list
  val uninstallTotal : IntSyn.cid -> bool
  val installTerminates : ThmSyn.tDecl * (Paths.region * Paths.region list) -> IntSyn.cid list
  val uninstallTerminates : IntSyn.cid -> bool
(* true: was declared, false not *)
  val installReduces : ThmSyn.rDecl * (Paths.region * Paths.region list) -> IntSyn.cid list
